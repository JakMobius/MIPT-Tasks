...
#ifndef BONK_COMPILER_REINVENTED_EDE_BACKEND_CONTEXT_H
#define BONK_COMPILER_REINVENTED_EDE_BACKEND_CONTEXT_H
...
struct backend_context {
    ...
    static backend_context* create(compiler* compiler, FILE* target);
    bool construct(compiler* compiler, FILE* target);
    ...
    void compile_assignment(tree_node_identifier* variable, tree_node* value, unsigned long stack_bytes_expected);
    ...
    tree_node* call_argument_list_get_value(tree_node_list<tree_node_call_parameter*>* argument_list, tree_node_identifier* identifier);
...
#endif //BONK_COMPILER_REINVENTED_EDE_BACKEND_CONTEXT_H
