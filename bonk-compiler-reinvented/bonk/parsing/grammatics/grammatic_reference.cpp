...
tree_node* parse_grammatic_reference(parser* parser) {
    ...
    if(is_call) {
        ...
        auto* call = tree_node_call::create((tree_node_identifier*)variable, arguments);
        if(!call) {
...
tree_node_list<tree_node_call_parameter*>* parse_grammatic_arguments(parser* parser) {
    ...
    auto* argument_list = tree_node_list<tree_node_call_parameter*>::create();
    if(!argument_list) {
        parser->linked_compiler->out_of_memory();
        return nullptr;
    }
    ...
    while(true) {
        ...
        auto* argument = tree_node_call_parameter::create(parameter_name, parameter_value);
