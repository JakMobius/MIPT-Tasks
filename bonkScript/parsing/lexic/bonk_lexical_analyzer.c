...
void bonk_lexical_analyzer_parse_file(s_bonk_lexical_analyzer* analyzer, const char* filename, const char* text) {
...
s_bonk_parser_position* bonk_parser_position_clone(s_bonk_parser_position* position) {
    ...
    memcpy(new_position, position, sizeof(*position));
    return new_position;
}