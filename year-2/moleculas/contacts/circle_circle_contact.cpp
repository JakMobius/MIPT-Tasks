...
CircleCircleContact::CircleCircleContact(CircleFixture* fixture_a, CircleFixture* fixture_b): Contact(fixture_a, fixture_b) {

}

void CircleCircleContact::response() {
    auto circle_a = (CircleFixture*) get_fixture_a();
    auto circle_b = (CircleFixture*) get_fixture_b();
...
Contact* CircleCircleContact::get_contact(CircleFixture* fixture_a, CircleFixture* fixture_b) {
