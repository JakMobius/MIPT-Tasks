...
class DialogWindow : public PhotoshopWindow {
protected:
...
public:
    explicit DialogWindow(PhotoshopView* app, const Vec2f& position = {0, 0}, const Vec2f& size = {0, 0}, const char* title = nullptr);
