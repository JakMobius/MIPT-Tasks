...
class GradientSliderStyle : public UISliderStyle {
    ...
    UIFillStyleColor* button_color = new UIFillStyleTexture(Assets.slider_bar_texture.get());
public:
...
class ColorPickerWindow: public AppWindow {
...
public:
    ColorPickerWindow(AppView* app, const Vec2f& position);;
