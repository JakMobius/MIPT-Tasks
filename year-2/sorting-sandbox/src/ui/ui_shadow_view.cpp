...
void UIShadowView::draw(DrawingContext* ctx) {
    ...
    fill_style.set_texture(Assets.window_shadow_texture.get());
    ...
    fill_style.set_scale({1, 1});
    fill_style.set_texture(Assets.window_shadow_horizontal_texture.get());
    ...
    fill_style.set_texture(Assets.window_shadow_corner_texture.get());
    fill_style.set_scale({1, 1});
