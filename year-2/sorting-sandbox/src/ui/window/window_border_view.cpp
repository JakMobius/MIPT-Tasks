...
void WindowBorderView::draw(DrawingContext* ctx) {
    ...
    fill_style.set_texture(Assets.window_border_vertical_texture.get());
    ...
    fill_style.set_scale({1, 1});
    fill_style.set_texture(Assets.window_border_horizontal_texture.get());
...
//        fill_style.set_color({1, 1, 1, 1});
    fill_style.set_texture(Assets.window_border_corner_texture.get());
    fill_style.set_scale({1, 1});
